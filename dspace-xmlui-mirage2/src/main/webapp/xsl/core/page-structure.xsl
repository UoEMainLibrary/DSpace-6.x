            ...
            <xsl:choose>
                <xsl:when test="starts-with($request-uri, 'about')">
                    <div class="hero-unit">
                        ...
                        <p>All of the above can be performed across the whole repository, within a particular community, or even within a specific collection (see '<a href="/about#organised">How is ROS organised?</a>').</p>
                ...
                <xsl:when test="starts-with($request-uri, 'accessibility')">
                    ...
                    <p>This accessibility statement applies to the “<a href="https://www.ros.hw.ac.uk/">ROS Theses Repository</a>” - <a href="https://www.ros.hw.ac.uk/">https://www.ros.hw.ac.uk/</a></p>
                    ...
                    <ul>
                        <li>The website is not fully compatible with assistive technologies (JAWS, TextHelp, Dragon Naturally Speaking)</li>
                        ...
                        <li>Not all hyperlinks are formatted correctly formatted hypertext</li>
                    ...
                    <p>We are always looking to improve the accessibility of this website. If you find any problopen.access@hw.ac.uk</p>
                    <p>Phone: +44 (0)131 451 3577</p>
                    <p>British Sign Language (BSL) users can contact us via <a href="http://contactscotland-bsl.org/">contactSCOTLAND-BSL</a>, the on-line BSL interpreting service</p>
                    <p>We'll consider your request and get back to you in 5 working days.</p>
                    ...
                    <ul>
                        <li>Not all foreground and background colours can be selected by the user. (Note this is a WCAG 2.1 AAA criteria)</li>
                        <ul>
                            <li><u><a href="https://www.w3.org/TR/WCAG21/#visual-presentation">1.4.8 Visual Presentation (AAA)</a></u></li>
                        </ul>
                    </ul>
                    <ul>
                        <li>There is justified text present. (Note this is a WCAG 2.1 AAA criteria)</li>
                        <ul>
                            <li><u><a href="https://www.w3.org/TR/WCAG21/#visual-presentation">1.4.8 Visual Presentation (AAA)</a></u></li>
                        </ul>
                    </ul>
                    ...
                    <ul>
                        <li>There missing labels present in the website so fail to describe the purpose of the input form</li>
                        <ul>
                    ...
                    <ul>
                        <li>No error suggestions or corrections are automatically</li>
                        <ul>
                    ...
                    <p>Unless specified otherwise, a complete solution, or significant improvement, will be in place by October 2023.</p>
                    ...
                    <p>Since our first evaluation and statement which was based on automated testing we have been doing extensive manual testing including with a range of assistive technology to ensure we have a clear picture of the accessibility issues and how best to resolve them. We will continue to address and make adequate improvements to the accessibility issues highlighted. Unless specified otherwise, a complete solution or significant improvement will be in place by October 2023.</p>
                    ...
                    <p>We are planning to upgrade the site to the most recent release of the system architecture before the end of 2023 and improving accessibility will be a key component of this process.</p>

                    <h2>Preparation of this accessibility statement</h2>
                    <p>This statement was first prepared on 1st August 2020. It was last reviewed on 13th October 2022.</p>
                    <p>This website was last tested by the Library and University Collections Digital Library team, University of Edinburgh in July 2022 following on from previous automated testing of the system the previous year. This was primarily using the Google Chrome (100.0.4896.127), Mozilla Firefox (91.8.0esr), Internet Explorer (11.0) and Microsoft Edge (100.0.1185.39) browsers for comparative purposes. Internet Explorer was considered the most commonly used browser by disabled people, notably due to its accessibility features and compatibility with assistive technology, as shown in a UK government survey:</p>
                    <p><a href="https://accessibility.blog.gov.uk/2016/11/01/results-of-the-2016-gov-uk-assistive-technology-survey/">UK Government Assistive Technology Browser Survey</a></p>
                    <p>However, a more recent world-wide usage levels survey for different screen readers and browsers shows that Chrome, Mozilla Firefox and Microsoft Edge are increasing in popularity and is now the favoured browser for screen readers:</p>
