        ...
        <div>
            ...
            <xsl:choose>
                ...
                <xsl:when test="starts-with($request-uri, 'page/accessibility')">
                    ...
                    <p>“<a href="https://www.ros.hw.ac.uk/">ROS Theses Repository</a>” - <a href="https://www.ros.hw.ac.uk/">https://www.ros.hw.ac.uk/</a> is a website hosted by the University of Edinburgh Library on behalf of Heriot Watt University. It contains full-text copies of all Heriot-Watt University PhD theses awarded from 2009 onwards</p>
                    ...
                    <ul>
                        <li>The default language of each page may not be identified.</li>
                        <ul>
                            <li><u><a href="https://www.w3.org/TR/WCAG21/#language-of-page">3.1.1 - Language of Page</a></u></li>
                        </ul>
                    </ul>
                    <ul>
                        <li>Entering data or selecting a form control does not always have predictable effects.</li>
                        <ul>
                            <li><u><a href="https://www.w3.org/TR/WCAG21/#on-input">3.2.2 - On Input</a></u></li>
                        </ul>
                    </ul>
                    ...
                    <h1>At this time we are not claiming any material is out of scope.</h1>
                    ...
                    <p><strong>This statement was prepared on </strong><strong>7<sup>th</sup> August 2020. It was last reviewed on 14<sup>th</sup> September 2020.</strong></p>
                    <p>This website was last tested on 10th September 2020. The test was carried out by The University Library and University Collections Digital Library team using the automated LittleForest tool. The website is scheduled for manual testing by Dec 2021.</p>
