        ...
        <div>
            ...
            <xsl:choose>
                ...
                <xsl:when test="starts-with($request-uri, 'page/accessibility')">
                    ...
                    <p>We will continue to address and make adequate improvements to the accessibility issues highlighted. Unless specified otherwise, a complete solution or significant improvement will be in place by October 2023.</p>
